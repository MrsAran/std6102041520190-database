...
-- -----------------------------------------------------
-- Schema std6102041520190
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema std6102041520190
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS 'std6102041520190' DEFAULT CHARACTER SET utf8 ;
USE 'mydb' ;
...
CREATE TABLE IF NOT EXISTS 'mydb'.'staff' (
  ...
  'branch_n' VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
   PRIMARY KEY ('id'))
ENGINE = MyISAM
DEFAULT CHARACTER SET = utf8;
...
-- Table `mydb`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS  'std6102041520190' .'user' (
...
-- -----------------------------------------------------
-- Table `std6102041520190`.`branch`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS 'std6102041520190'.'branch' (
  'id' INT(11) NOT NULL AUTO_INCREMENT,
  'branch_no' VARCHAR(5) NOT NULL,
  'street' TEXT NULL DEFAULT NULL,
  'city' VARCHAR(50) NOT NULL,
...
-- -----------------------------------------------------
-- Table `std6102041520190`.`client`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS 'std6102041520190'.'client' (
  'id' INT(11) NOT NULL AUTO_INCREMENT,
  'client_no' VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  'f_name' VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  'l_name' VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
...
-- -----------------------------------------------------
-- Table `std6102041520190`.`private_owner`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS 'std6102041520190'.'private_owner'(
  'id' INT(11) NOT NULL AUTO_INCREMENT,
  'owner_no' VARCHAR(50) NOT NULL,
  'f_name' VARCHAR(50) NOT NULL,
  'l_name' VARCHAR(50) NOT NULL,
...
-- -----------------------------------------------------
-- Table `std6102041520190`.`staff`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS 'std6102041520190'.'staff' (
  'id' INT(11) NOT NULL AUTO_INCREMENT,
  'staff_no' VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  'f_name' VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  'l_name' VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
...
-- -----------------------------------------------------
-- Table `std6102041520190`.`property_for_rent`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS 'std6102041520190'.'property_for_rent' (
  'id'INT(11) NOT NULL AUTO_INCREMENT,
  'property_no' VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  'street'VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  'city' VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  ...
  INDEX 'fk_property_for_rent_staff1_id' ('staff_id' ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `std6102041520190`.`registration`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS 'std6102041520190'.'registration' (
  'id' INT(11) NOT NULL AUTO_INCREMENT,
  'client_no' VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  'branch_no' VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  'staff_no' VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
...
-- -----------------------------------------------------
-- Table `std6102041520190`.`viewing`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS 'std6102041520190`.'viewing' (
  'id' INT(11) NOT NULL AUTO_INCREMENT,
  'client_no' VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  'property_no' VARCHAR(50) CHARACTER SET 'utf8' COLLATE 'utf8_unicode_ci' NOT NULL,
  'view_date' DATE NOT NULL,
